...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    switch (indexPath.row) {
        case 0:{
            ...
            [self.navigationController animation_pushViewController:magicMoveVC type:KAnimationTransitionTypeNone];
        ...
        case 2:{
            ...
            [self.navigationController animation_pushViewController:commentVC type:KAnimationTransitionTypeNone];
        ...
        case 3:{
            ...
            [self.navigationController animation_pushViewController:maskVC type:KAnimationTransitionTypeNone];
